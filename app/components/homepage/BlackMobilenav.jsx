...
export default function BlackMobileNavbar() {
  ...
  return (
    <div className="md:hidden">
      ...
      <div 
        className={`fixed inset-0 bg-white text-black flex flex-col justify-start items-start px-8 pt-24 space-y-8 z-40 transition-transform duration-700 ease-in-out transform ${
